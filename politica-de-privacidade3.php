    ...
    <div class="row g-5">
      ...
      <aside class="col-lg-3 d-none d-lg-block">
        <nav class="reg-toc" aria-label="Índice da política de privacidade">
          ...
          <ul class="reg-toc-list">
            ...
            <li><a href="#sec-bases-legais"><span class="toc-num">–</span> Bases Legais</a></li>
            <li><a href="#sec-compartilhamento"><span class="toc-num">–</span> Compartilhamento</a></li>
            <li><a href="#sec-cookies"><span class="toc-num">–</span> Cookies</a></li>
            <li><a href="#sec-retencao"><span class="toc-num">–</span> Retenção</a></li>
            <li><a href="#sec-seguranca"><span class="toc-num">–</span> Segurança</a></li>
            <li><a href="#sec-direitos"><span class="toc-num">–</span> Seus Direitos</a></li>
            <li><a href="#sec-menores"><span class="toc-num">–</span> Menores de Idade</a></li>
      ...
      <div class="col-lg-9">
        ...
        <section id="sec-coleta" class="reg-section">
            ...
            <table class="table table-bordered align-middle" style="font-size:.9rem;">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Nome completo, CPF, data de nascimento, e-mail, telefone, gênero, formação acadêmica, endereço completo (CEP, rua, número, complemento, cidade e estado).</td>
                </tr>
                <tr>
                  <td><strong>Dados da pessoa jurídica</strong></td>
                  <td>Razão social, nome fantasia, CNPJ, município de atuação, redes sociais (LinkedIn, Instagram, Facebook, TikTok, YouTube) e site.</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>Dados coletados por meio de cookies, páginas visitadas no nosso site, informação que você busca/procura, duração da sua visita, localização geográfica, tipo de navegador e páginas visitadas.</td>
                </tr>
                <tr>
                  <td><strong>Dados de votação</strong></td>
                  <td>Registros de votos realizados (popular, técnico e júri), vinculados ao seu cadastro, para fins de auditoria e prevenção a fraudes.</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <!-- Bases Legais -->
          <div class="reg-article" id="sec-bases-legais">
          ...
          <!-- Compartilhamento -->
          <div class="reg-article mt-3" id="sec-compartilhamento">
          ...
          <!-- Cookies -->
          <div class="reg-article" id="sec-cookies">
            <span class="reg-article-num">1.10</span>
          ...
          <div class="reg-article"><span class="reg-article-num">Funcionais</span> Lembram suas preferências para personalizar sua experiência. Você pode gerenciá-los pelas configurações do seu navegador.</div>

          <!-- Retenção -->
          <div class="reg-article mt-3" id="sec-retencao">
            <span class="reg-article-num">1.11</span>
            Mantemos seus dados pelo tempo necessário para cumprir as finalidades descritas nesta política. Dados de inscrição e participação no Prêmio são mantidos por até <strong>5 anos</strong> após o encerramento de cada edição, após o qual são anonimizados ou excluídos de forma segura.
          </div>
          <div class="reg-article">
            <span class="reg-article-num">1.12</span>
            Você pode solicitar a exclusão antecipada dos seus dados a qualquer momento pelo e-mail <a href="mailto:contato@impactospositivos.com" class="reg-ext-link">contato@impactospositivos.com</a>.
          </div>

          <!-- Segurança -->
          <div class="reg-article mt-3" id="sec-seguranca">
            <span class="reg-article-num">1.13</span>
            Adotamos medidas técnicas e organizacionais adequadas para proteger seus dados contra acesso não autorizado, perda ou alteração indevida, incluindo controle de acesso por autenticação, criptografia (HTTPS/TLS), monitoramento de acessos e backups regulares. Em caso de incidente de segurança relevante, comunicaremos a ANPD e os afetados nos prazos previstos pela LGPD.
          </div>

          <!-- Direitos do Titular -->
          <div class="reg-article mt-3" id="sec-direitos">
            <span class="reg-article-num">1.14</span>
            Nos termos da LGPD, você tem direito a: <strong>acesso</strong>, <strong>correção</strong>, <strong>eliminação</strong>, <strong>revogação do consentimento</strong>, <strong>portabilidade</strong>, <strong>oposição</strong> e <strong>bloqueio/anonimização</strong> dos seus dados. Para exercer qualquer um desses direitos, envie uma solicitação para <a href="mailto:contato@impactospositivos.com" class="reg-ext-link">contato@impactospositivos.com</a>. Responderemos em até <strong>15 dias úteis</strong>.
          </div>

          <!-- Menores -->
          <div class="reg-article mt-3" id="sec-menores">
            <span class="reg-article-num">1.15</span>
            A participação de menores de idade é de exclusiva responsabilidade dos pais ou responsáveis legais, que devem fornecer consentimento específico e em destaque, nos termos do art. 14 da LGPD. Caso identifiquemos que dados de menores foram coletados sem o devido consentimento, procederemos à exclusão imediata.
          </div>
        ...
        <section id="sec-geral" class="reg-section">
          ...
          <div class="reg-article">
            <span class="reg-article-num">2.7</span>
            Esta Política de Privacidade pode ser atualizada periodicamente. Alterações significativas serão comunicadas por e-mail ou aviso na plataforma com antecedência mínima de 10 dias. A versão em vigor é sempre a disponível em <a href="https://www.impactospositivos.com/politica-de-privacidade" target="_blank" rel="noopener" class="reg-ext-link">impactospositivos.com/politica-de-privacidade</a>.
          </div>

          <div class="reg-article">
            <span class="reg-article-num">2.8</span>
